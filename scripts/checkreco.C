...
void checkreco(){
	...
	ch_ee_rereco->Draw("dilmass>>h_ee_re", "dilmass >= 81 && dilmass <= 101 && hyp_type == 0 && lep_pt[0] >= 25 && lep_pt[1] >= 20 && abs(lep_p4[0].eta()) < 2.4 && abs(lep_p4[1].eta()) < 2.4 && evt_type == 0 && (!(abs(lep_p4[0].eta()) > 1.4 && abs(phys.lep_p4[0].eta()) < 1.6 ))) &&  (!(abs(lep_p4[1].eta()) > 1.4 && abs(phys.lep_p4[1].eta()) < 1.6 )))");
